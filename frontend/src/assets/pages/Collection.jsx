  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
        ...
        <div className='min-w-60'>
            ...
            {/* {Category} */}
            <div className={`border boder-gray-300 pl-5 py-3 mt-6 ${showFilters?'':'hidden'} sm:block`}>
            ...
            {/* {SubCategory} */}
             <div className={`border boder-gray-300 pl-5 py-3 my-5 ${showFilters?'':'hidden'} sm:block`}>
